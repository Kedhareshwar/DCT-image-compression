...
originalImage = imread('STScI-01H5309J2AAYSABKVQ89R7V44T.png'); % Replace with your image path
...
imwrite(compressedImage, 'compressed_image_rgbv4tt.jpg'); % Replace with your desired output path
